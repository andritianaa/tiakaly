...
export function UserPermissions({ user, onUserUpdated }: UserPermissionsProps) {
          ...
          {isEditing ? (
            <div className="space-y-4">
              <p className="text-sm text-muted-foreground">
                Select the roles you want to assign to this user. Each role
            ...
            <div className="space-y-4">
              ...
              <div className="bg-muted rounded-md p-4">
                ...
                <ul className="space-y-2">
                  {availableRoles
                    .filter((role) =>
                      user.permissions?.includes(role.id as Roles)
                    )
                    .map((role) => (
