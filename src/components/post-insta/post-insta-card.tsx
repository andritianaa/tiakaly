...
export function PostInstaCard({ post }: PostInstaCardProps) {
  return (
    <Link
      ...
      key={post.id}
      className="relative overflow-hidden rounded max-h-[45vh] min-h-[45vh] bg-muted transition-transform duration-300 hover:scale-105 "
    >
      <Image
        ...
        height={500}
        alt={post.title}
        className="h-full w-full object-cover max-h-[45vh] min-h-[45vh]"
      />
